...
public class SleepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardview2=findViewById(R.id.cardView2_img);
        cardview_anim= AnimationUtils.loadAnimation(this, R.anim.cardview_anim);

        cardview2.setAnimation(cardview_anim);
        ...
        play_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startService(new Intent(SleepActivity.this, SleepService.class));
            }
            public void onBackPressed(){
                stopService(new Intent(SleepActivity.this, SleepService.class));
            }
        });
    ...
    private void VolumeControls() {
        ...
        SeekBar seekBar = (SeekBar) findViewById(R.id.volume_seekbar9);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar arg0, int progress, boolean arg2) {
                ...
                Toast.makeText(SleepActivity.this, Volume, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
