...
public class InstrumentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardview4 = findViewById(R.id.cardView4_img);
        cardview_anim = AnimationUtils.loadAnimation(this, R.anim.cardview_anim);

        cardview4.setAnimation(cardview_anim);
        ...
        play_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startService(new Intent(InstrumentsActivity.this, InstrumentsService.class));
            }

            public void onBackPressed() {
                stopService(new Intent(InstrumentsActivity.this, InstrumentsService.class));
            }
        });
    ...
    private void VolumeControls() {
        ...
        SeekBar seekBar = (SeekBar) findViewById(R.id.volume_seekbar4);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar arg0, int progress, boolean arg2) {
                ...
                Toast.makeText(InstrumentsActivity.this, Volume, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
