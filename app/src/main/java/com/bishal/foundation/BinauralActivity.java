...
public class BinauralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardview6 = findViewById(R.id.cardView6_img);
        cardview_anim = AnimationUtils.loadAnimation(this, R.anim.cardview_anim);

        cardview6.setAnimation(cardview_anim);
        ...
        play_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startService(new Intent(BinauralActivity.this, BinauralService.class));
            }

            public void onBackPressed() {
                stopService(new Intent(BinauralActivity.this, BinauralService.class));
            }
        });
    ...
    private void VolumeControls() {
        ...
        SeekBar seekBar = (SeekBar) findViewById(R.id.volume_seekbar3);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar arg0, int progress, boolean arg2) {
                ...
                Toast.makeText(BinauralActivity.this, Volume, Toast.LENGTH_SHORT).show();
            }
        });
    }
}